...
class ReadinessTank(Base):
    ...
    date_expired_tera               = Column(Text)
    status_tera                     = Column(Text)
    cert_no_tera                    = Column(Text)
    status_atg                      = Column(Text)
    ...
    remark_grounding                = Column(Text)
    rtl_grounding                   = Column(Text)
    status_bonding                  = Column(Text)
    remark_bonding                  = Column(Text)
    rtl_bonding                     = Column(Text)
    status_temp_indicator           = Column(Text)
    remark_temp_indicator           = Column(Text)
    rtl_temp_indicator              = Column(Text)
    status_level_indicator          = Column(Text)
    remark_level_indicator          = Column(Text)
    rtl_level_indicator             = Column(Text)
    status_gauge_hatch              = Column(Text)
    remark_gauge_hatch              = Column(Text)
    rtl_gauge_hatch                 = Column(Text)
    status_alarm                    = Column(Text)
    remark_alarm                    = Column(Text)
    rtl_alarm                       = Column(Text)
    status_ihla                     = Column(Text)
    remark_ihla                     = Column(Text)
    rtl_ihla                        = Column(Text)
    status_water_sprinkle           = Column(Text)
    remark_water_sprinkle           = Column(Text)
    rtl_water_sprinkle              = Column(Text)
    status_foam_chamber             = Column(Text)
    remark_foam_chamber             = Column(Text)
    rtl_foam_chamber                = Column(Text)
    status_gun_monitor              = Column(Text)
    remark_gun_monitor              = Column(Text)
    rtl_gun_monitor                 = Column(Text)
    status_fgds                     = Column(Text)
    remark_fgds                     = Column(Text)
    rtl_fgds                        = Column(Text)
    status_lps                      = Column(Text)
    remark_lps                      = Column(Text)
    rtl_lps                         = Column(Text)
    status_cathodic                 = Column(Text)
    remark_cathodic                 = Column(Text)
    rtl_cathodic                    = Column(Text)
    ...
    status_pv_vent                  = Column(Text)
    remark_pv_vent                  = Column(Text)
    rtl_pv_vent                     = Column(Text)
    status_tank_heater              = Column(Text)
    remark_tank_heater              = Column(Text)
    rtl_tank_heater                 = Column(Text)
    status_mixer                    = Column(Text)
    remark_mixer                    = Column(Text)
    rtl_mixer                       = Column(Text)
    status_stairway                 = Column(Text)
    remark_stairway                 = Column(Text)
    rtl_stairway                    = Column(Text)
    status_annular_plate            = Column(Text)
    remark_annular_plate            = Column(Text)
    rtl_annular_plate               = Column(Text)
    status_bottom_plate             = Column(Text)
    remark_bottom_plate             = Column(Text)
    rtl_bottom_plate                = Column(Text)
    status_gate_valve               = Column(Text)
    remark_gate_valve               = Column(Text)
    rtl_gate_valve                  = Column(Text)
    status_foundation               = Column(Text)
    remark_foundation               = Column(Text)
    rtl_foundation                  = Column(Text)
    status_expansion_joint          = Column(Text)
    remark_expansion_joint          = Column(Text)
    rtl_expansion_joint             = Column(Text)
    status_roof_drain               = Column(Text)
    remark_roof_drain               = Column(Text)
    rtl_roof_drain                  = Column(Text)
    status_esv_psv                  = Column(Text)
    remark_esv_psv                  = Column(Text)
    rtl_esv_psv                     = Column(Text)
    status_mov                      = Column(Text)
    remark_mov                      = Column(Text)
    rtl_mov                         = Column(Text)
    status_rolling_ladder           = Column(Text)
    remark_rolling_ladder           = Column(Text)
    rtl_rolling_ladder              = Column(Text)
    status_skirt_fireproofing       = Column(Text)
    remark_skirt_fireproofing       = Column(Text)
    rtl_skirt_fireproofing          = Column(Text)
    status_painting                 = Column(Text)
    remark_painting                 = Column(Text)
    rtl_painting                    = Column(Text)
    status_roof_seal                = Column(Text)
    remark_roof_seal                = Column(Text)
    rtl_roof_seal                   = Column(Text)
    month_update                    = Column(Text)
    periode                         = Column(Text)
