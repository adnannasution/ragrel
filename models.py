...
class ReadinessJetty(Base):
    ...
    rtl_struktur                = Column(Text)
    status_mooring_dolphin      = Column(Text)
    remark_mooring_dolphin      = Column(Text)
    rtl_mooring_dolphin         = Column(Text)
    status_breasting_dolphin    = Column(Text)
    remark_breasting_dolphin    = Column(Text)
    rtl_breasting_dolphin       = Column(Text)
    status_trestle              = Column(Text)
    remark_trestle              = Column(Text)
    rtl_trestle                 = Column(Text)
    status_rubber_fender        = Column(Text)
    remark_rubber_fender        = Column(Text)
    rtl_rubber_fender           = Column(Text)
    status_mla                  = Column(Text)
    remark_mla                  = Column(Text)
    rtl_mla                     = Column(Text)
    status_arc                  = Column(Text)
    remark_arc                  = Column(Text)
    rtl_arc                     = Column(Text)
    status_qrh                  = Column(Text)
    remark_qrh                  = Column(Text)
    rtl_qrh                     = Column(Text)
    status_piping               = Column(Text)
    remark_piping               = Column(Text)
    rtl_piping                  = Column(Text)
    status_cathodic             = Column(Text)
    remark_cathodic             = Column(Text)
    rtl_cathodic                = Column(Text)
    status_grounding            = Column(Text)
    remark_grounding            = Column(Text)
    rtl_grounding               = Column(Text)
    status_catwalk              = Column(Text)
    remark_catwalk              = Column(Text)
    rtl_catwalk                 = Column(Text)
    status_gangway              = Column(Text)
    remark_gangway              = Column(Text)
    rtl_gangway                 = Column(Text)
    status_lampu                = Column(Text)
    remark_lampu                = Column(Text)
    rtl_lampu                   = Column(Text)
    status_crane                = Column(Text)
    remark_crane                = Column(Text)
    rtl_crane                   = Column(Text)
    status_berthing             = Column(Text)
    remark_berthing             = Column(Text)
    rtl_berthing                = Column(Text)
    status_alur                 = Column(Text)
    remark_alur                 = Column(Text)
    rtl_alur                    = Column(Text)
    status_fire_protection      = Column(Text)
    remark_fire_protection      = Column(Text)
    rtl_fire_protection         = Column(Text)
    status_oil_pollution        = Column(Text)
    remark_oil_pollution        = Column(Text)
    rtl_oil_pollution           = Column(Text)
    status_apar                 = Column(Text)
    remark_apar                 = Column(Text)
    rtl_apar                    = Column(Text)
    month_update                = Column(Text)
    periode                     = Column(Text)
...
class ReadinessTank(Base):
    ...
    rtl_shell_course          = Column(Text)
    status_roof               = Column(Text)
    remark_roof               = Column(Text)
    rtl_roof                  = Column(Text)
    status_cathodic           = Column(Text)
    remark_cathodic           = Column(Text)
    rtl_cathodic              = Column(Text)
    month_update              = Column(Text)
...
class ReadinessSPM(Base):
    ...
    rtl_mbc                   = Column(Text)
    status_guard_rail         = Column(Text)
    remark_guard_rail         = Column(Text)
    rtl_guard_rail            = Column(Text)
    status_lds                = Column(Text)
    remark_lds                = Column(Text)
    rtl_lds                   = Column(Text)
    status_navigation_aid     = Column(Text)
    remark_navigation_aid     = Column(Text)
    rtl_navigation_aid        = Column(Text)
    status_buoy_body          = Column(Text)
    remark_buoy_body          = Column(Text)
    rtl_buoy_body             = Column(Text)
    status_turn_table         = Column(Text)
    remark_turn_table         = Column(Text)
    rtl_turn_table            = Column(Text)
    status_mrb                = Column(Text)
    remark_mrb                = Column(Text)
    rtl_mrb                   = Column(Text)
    status_swivel_bearing     = Column(Text)
    remark_swivel_bearing     = Column(Text)
    rtl_swivel_bearing        = Column(Text)
    status_cpu                = Column(Text)
    remark_cpu                = Column(Text)
    rtl_cpu                   = Column(Text)
    status_mooring_hawser     = Column(Text)
    remark_mooring_hawser     = Column(Text)
    rtl_mooring_hawser        = Column(Text)
    status_anchor_chain       = Column(Text)
    remark_anchor_chain       = Column(Text)
    rtl_anchor_chain          = Column(Text)
    status_floating_hose      = Column(Text)
    remark_floating_hose      = Column(Text)
    rtl_floating_hose         = Column(Text)
    status_subsea_hose        = Column(Text)
    remark_subsea_hose        = Column(Text)
    rtl_subsea_hose           = Column(Text)
    status_camlock            = Column(Text)
    remark_camlock            = Column(Text)
    rtl_camlock               = Column(Text)
    status_cathodic_spl       = Column(Text)
    remark_cathodic_spl       = Column(Text)
    rtl_cathodic_spl          = Column(Text)
    status_cathodic_spm       = Column(Text)
    remark_cathodic_spm       = Column(Text)
    rtl_cathodic_spm          = Column(Text)
    status_expansion_joint    = Column(Text)
    remark_expansion_joint    = Column(Text)
    rtl_expansion_joint       = Column(Text)
    status_plem               = Column(Text)
    remark_plem               = Column(Text)
    rtl_plem                  = Column(Text)
    status_pressure_indicator = Column(Text)
    remark_pressure_indicator = Column(Text)
    rtl_pressure_indicator    = Column(Text)
    status_submarine_pipeline = Column(Text)
    remark_submarine_pipeline = Column(Text)
    rtl_submarine_pipeline    = Column(Text)
    status_temp_indicator     = Column(Text)
    remark_temp_indicator     = Column(Text)
    rtl_temp_indicator        = Column(Text)
    month_update              = Column(Text)
    periode                   = Column(Text)
